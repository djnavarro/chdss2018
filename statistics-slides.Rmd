...
.column.bg-main3[.content.vtop.center[
.pull.left[.pad1[.font2[
```{r ttest, cache=TRUE, eval=TRUE, message = FALSE, echo=FALSE}
t.test(
  formula = response ~ condition, 
  data = tinyframes, 
  var.equal = TRUE
...
.row.bg-main3[.content.vtop.center[
.pull.left[.pad1[.font2[
```{r lmdemo, cache=TRUE, eval=TRUE, message = FALSE, echo=FALSE}
mod1 <- lm(formula = response ~ 1, data = tinyframes) 
mod2 <- lm(formula = response ~ condition, data = tinyframes)
...
.row.bg-main3[.content.vtop.center[
.pull.left[.pad1[.font2[
```{r lmanova, cache=TRUE, eval=TRUE, message = FALSE, echo=FALSE}
mod1 <- lm(formula = response ~ 1, data = tinyframes) 
mod2 <- lm(formula = response ~ condition, data = tinyframes)
...
.row.bg-main3[.content.vtop.center[
.pull.left[.pad1[.font2[
```{r anovalm2, cache=TRUE, eval=TRUE, message = FALSE, echo=FALSE}
mod1 <- lm(formula = response ~ 1, data = tinyframes) 
mod2 <- lm(formula = response ~ condition, data = tinyframes)
mod3 <- lm(formula = response ~ condition + age, data = tinyframes)
...
.row.bg-main3[.content.vtop.center[
.pull.left[.pad1[.font2[
```{r aiclm, cache=TRUE, eval=TRUE, message = FALSE, echo=FALSE}
mod1 <- lm(formula = response ~ 1, data = tinyframes) 
mod2 <- lm(formula = response ~ condition, data = tinyframes)
mod3 <- lm(formula = response ~ condition + age, data = tinyframes)
...
.row.bg-main3[.content.vtop.center[
.pull.left[.pad1[.font2[
```{r biclm, cache=TRUE, eval=TRUE, message = FALSE, echo=FALSE}
mod1 <- lm(formula = response ~ 1, data = tinyframes) 
mod2 <- lm(formula = response ~ condition, data = tinyframes)
mod3 <- lm(formula = response ~ condition + age, data = tinyframes)
